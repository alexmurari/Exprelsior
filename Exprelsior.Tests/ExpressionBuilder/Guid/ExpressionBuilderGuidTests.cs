namespace Exprelsior.Tests.ExpressionBuilder.Guid
{
    ...
    public class ExpressionBuilderGuidTests : ExpressionBuilderTestBase, IExpressionBuilderGuidTests
    {
        ...
        public void Assert_Guid_Equality_Expression_Is_Generated_Correctly()
        {
            ...
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.Guid), randomHydra.Guid, ExpressionOperator.Equal);
        ...
        public void Assert_Guid_Inequality_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.Guid), randomHydra.Guid, ExpressionOperator.NotEqual);
        ...
        public void Assert_Guid_Contains_On_Value_Expression_Is_Generated_Correctly()
        {
            ...
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.Guid), randomGuids, ExpressionOperator.ContainsOnValue);
        ...
        public void Assert_Guid_Array_Equality_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.GuidArray), randomHydra.GuidArray, ExpressionOperator.Equal);
        ...
        public void Assert_Guid_Array_Inequality_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.GuidArray), randomHydra.GuidArray, ExpressionOperator.NotEqual);
        ...
        public void Assert_Guid_Array_Equality_Expression_With_List_Value_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.GuidArray), randomHydra.GuidArray.ToList(), ExpressionOperator.Equal);
        ...
        public void Assert_Guid_Array_Inequality_Expression_With_List_Value_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.GuidArray), randomHydra.GuidArray.ToList(), ExpressionOperator.NotEqual);
        ...
        public void Assert_Guid_Array_Contains_Single_Value_Expression_Is_Generated_Correctly()
        {
            ...
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.GuidArray), randomGuid, ExpressionOperator.Contains);
        ...
        public void Assert_Guid_Collection_Equality_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.GuidCollection), randomHydra.GuidCollection, ExpressionOperator.Equal);
        ...
        public void Assert_Guid_Collection_Inequality_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.GuidCollection), randomHydra.GuidCollection, ExpressionOperator.NotEqual);
        ...
        public void Assert_Guid_Collection_Equality_Expression_With_Array_Value_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.GuidCollection), randomHydra.GuidCollection.ToArray(), ExpressionOperator.Equal);
        ...
        public void Assert_Guid_Collection_Inequality_Expression_With_Array_Value_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.GuidCollection), randomHydra.GuidCollection.ToArray(), ExpressionOperator.NotEqual);
        ...
        public void Assert_Guid_Collection_Contains_Single_Value_Expression_Is_Generated_Correctly()
        {
            ...
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.GuidCollection), randomGuid, ExpressionOperator.Contains);
