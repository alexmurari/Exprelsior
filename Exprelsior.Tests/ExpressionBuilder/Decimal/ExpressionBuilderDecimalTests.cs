namespace Exprelsior.Tests.ExpressionBuilder.Decimal
{
    ...
    /// </summary>
    public class ExpressionBuilderDecimalTests : ExpressionBuilderTestBase, IExpressionBuilderDecimalTests
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="ExpressionBuilderDecimalTests"/> class.
        /// </summary>
        /// <param name="testOutput">
        ///     The class responsible for providing test output.
        /// </param>
        public ExpressionBuilderDecimalTests(ITestOutputHelper testOutput) : base(testOutput)
        {
        }
        ...
        /// </summary>
        [Fact]
        public void Assert_Decimal_Equality_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.Decimal), randomHydra.Decimal, ExpressionOperator.Equal);
        ...
        /// </summary>
        [Fact]
        public void Assert_Decimal_Inequality_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.Decimal), randomHydra.Decimal, ExpressionOperator.NotEqual);
        ...
        /// </summary>
        [Fact]
        public void Assert_Decimal_Less_Than_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.Decimal), randomHydra.Decimal, ExpressionOperator.LessThan);
        ...
        /// </summary>
        [Fact]
        public void Assert_Decimal_Less_Than_Or_Equal_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.Decimal), randomHydra.Decimal, ExpressionOperator.LessThanOrEqual);
        ...
        /// </summary>
        [Fact]
        public void Assert_Decimal_Greater_Than_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.Decimal), randomHydra.Decimal, ExpressionOperator.GreaterThan);
        ...
        /// </summary>
        [Fact]
        public void Assert_Decimal_Greater_Than_Or_Equal_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.Decimal), randomHydra.Decimal, ExpressionOperator.GreaterThanOrEqual);
        ...
        /// </summary>
        [Fact]
        public void Assert_Decimal_Contains_On_Value_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomDecimals = Utilities.GetRandomItems(HydraArmy.Select(t => t.Decimal));
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.Decimal), randomDecimals, ExpressionOperator.ContainsOnValue);
        ...
        /// </summary>
        [Fact]
        public void Assert_Decimal_Array_Equality_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.DecimalArray), randomHydra.DecimalArray, ExpressionOperator.Equal);
        ...
        /// </summary>
        [Fact]
        public void Assert_Decimal_Array_Inequality_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.DecimalArray), randomHydra.DecimalArray, ExpressionOperator.NotEqual);
        ...
        public void Assert_Decimal_Array_Equality_Expression_With_List_Value_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.DecimalArray), randomHydra.DecimalArray.ToList(), ExpressionOperator.Equal);
        ...
        public void Assert_Decimal_Array_Inequality_Expression_With_List_Value_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.DecimalArray), randomHydra.DecimalArray.ToList(), ExpressionOperator.NotEqual);
        ...
        /// </summary>
        [Fact]
        public void Assert_Decimal_Array_Contains_Single_Value_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomDecimal = Utilities.GetRandomItem(HydraArmy.Select(t => t.DecimalArray)).FirstOrDefault();
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.DecimalArray), randomDecimal, ExpressionOperator.Contains);
        ...
        /// </summary>
        [Fact]
        public void Assert_Decimal_Collection_Equality_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.DecimalCollection), randomHydra.DecimalCollection, ExpressionOperator.Equal);
        ...
        /// </summary>
        [Fact]
        public void Assert_Decimal_Collection_Inequality_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.DecimalCollection), randomHydra.DecimalCollection, ExpressionOperator.NotEqual);
        ...
        public void Assert_Decimal_Collection_Equality_Expression_With_Array_Value_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.DecimalCollection), randomHydra.DecimalCollection.ToArray(), ExpressionOperator.Equal);
        ...
        public void Assert_Decimal_Collection_Inequality_Expression_With_Array_Value_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.DecimalCollection), randomHydra.DecimalCollection.ToArray(), ExpressionOperator.NotEqual);
        ...
        /// </summary>
        [Fact]
        public void Assert_Decimal_Collection_Contains_Single_Value_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomDecimal = Utilities.GetRandomItem(HydraArmy.Select(t => t.DecimalCollection)).FirstOrDefault();
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.DecimalCollection), randomDecimal, ExpressionOperator.Contains);
