namespace Exprelsior.Tests.ExpressionBuilder.DateTime.Contracts
{
    ...
    /// </summary>
    public interface IExpressionBuilderNullableDateTimeTests
    {
        // DateTime
        ...
        /// </summary>
        [Fact]
        void Assert_Nullable_DateTime_Array_Equality_Expression_Is_Generated_Correctly();

        /// <summary>
        ///     Asserts that an array of <see cref="DateTime"/>? <see cref="ExpressionOperator.NotEqual"/> expression is generated correctly.
        /// </summary>
        [Fact]
        void Assert_Nullable_DateTime_Array_Inequality_Expression_Is_Generated_Correctly();
        ...
        /// </summary>
        [Fact]
        void Assert_Nullable_DateTime_Array_Contains_Single_Value_Expression_Is_Generated_Correctly();
        ...
        /// </summary>
        [Fact]
        void Assert_Nullable_DateTime_Collection_Equality_Expression_Is_Generated_Correctly();

        /// <summary>
        ///     Asserts that an collection of <see cref="DateTime"/>? <see cref="ExpressionOperator.NotEqual"/> expression is generated correctly.
        /// </summary>
        [Fact]
        void Assert_Nullable_DateTime_Collection_Inequality_Expression_Is_Generated_Correctly();
        ...
        /// </summary>
        [Fact]
        void Assert_Nullable_DateTime_Collection_Contains_Single_Value_Expression_Is_Generated_Correctly();
    }
}
