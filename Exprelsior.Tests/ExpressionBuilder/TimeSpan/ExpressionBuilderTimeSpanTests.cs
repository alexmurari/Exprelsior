namespace Exprelsior.Tests.ExpressionBuilder.TimeSpan
{
    using System;
    using System.Linq;
    using Exprelsior.ExpressionBuilder;
    using Exprelsior.ExpressionBuilder.Enums;
    using Exprelsior.Tests.ExpressionBuilder.TimeSpan.Contracts;
    ...
    /// </summary>
    public class ExpressionBuilderTimeSpanTests : ExpressionBuilderTestBase, IExpressionBuilderTimeSpanTests
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="ExpressionBuilderTimeSpanTests"/> class.
        /// </summary>
        /// <param name="testOutput">
        ///     The class responsible for providing test output.
        /// </param>
        public ExpressionBuilderTimeSpanTests(ITestOutputHelper testOutput) : base(testOutput)
        {
        }
        ...
        /// </summary>
        [Fact]
        public void Assert_TimeSpan_Equality_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.TimeSpan), randomHydra.TimeSpan, ExpressionOperator.Equal);
        ...
        /// </summary>
        [Fact]
        public void Assert_TimeSpan_Inequality_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.TimeSpan), randomHydra.TimeSpan, ExpressionOperator.NotEqual);
        ...
        /// </summary>
        [Fact]
        public void Assert_TimeSpan_Greater_Than_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.TimeSpan), randomHydra.TimeSpan, ExpressionOperator.GreaterThan);
        ...
        /// </summary>
        [Fact]
        public void Assert_TimeSpan_Greater_Than_Or_Equal_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.TimeSpan), randomHydra.TimeSpan, ExpressionOperator.GreaterThanOrEqual);
        ...
        /// </summary>
        [Fact]
        public void Assert_TimeSpan_Array_Inequality_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.TimeSpanArray), randomHydra.TimeSpanArray, ExpressionOperator.NotEqual);
        ...
        public void Assert_TimeSpan_Array_Inequality_Expression_With_List_Value_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.TimeSpanArray), randomHydra.TimeSpanArray.ToList(), ExpressionOperator.NotEqual);
        ...
        /// </summary>
        [Fact]
        public void Assert_TimeSpan_Array_Contains_Single_Value_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomTimeSpan = Utilities.GetRandomItem(HydraArmy.Select(t => t.TimeSpanArray)).FirstOrDefault();
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.TimeSpanArray), randomTimeSpan, ExpressionOperator.Contains);
        ...
        /// </summary>
        [Fact]
        public void Assert_TimeSpan_Collection_Equality_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.TimeSpanCollection), randomHydra.TimeSpanCollection, ExpressionOperator.Equal);
        ...
        /// </summary>
        [Fact]
        public void Assert_TimeSpan_Collection_Inequality_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.TimeSpanCollection), randomHydra.TimeSpanCollection, ExpressionOperator.NotEqual);
        ...
        public void Assert_TimeSpan_Collection_Equality_Expression_With_Array_Value_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.TimeSpanCollection), randomHydra.TimeSpanCollection.ToArray(), ExpressionOperator.Equal);
        ...
        public void Assert_TimeSpan_Collection_Inequality_Expression_With_Array_Value_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.TimeSpanCollection), randomHydra.TimeSpanCollection.ToArray(), ExpressionOperator.NotEqual);
        ...
        /// </summary>
        [Fact]
        public void Assert_TimeSpan_Collection_Contains_Single_Value_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomTimeSpan = Utilities.GetRandomItem(HydraArmy.Select(t => t.TimeSpanCollection)).FirstOrDefault();
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.TimeSpanCollection), randomTimeSpan, ExpressionOperator.Contains);
