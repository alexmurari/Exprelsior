namespace Exprelsior.Tests.ExpressionBuilder.SimpleExpressions.TimeSpan.Contracts
{
    using System;
    ...
    /// </summary>
    public interface IExpressionBuilderTimeSpanTests
    {
        // TimeSpan
        ...
        /// </summary>
        [Fact]
        void Assert_TimeSpan_Array_Equality_Expression_Is_Generated_Correctly();

        /// <summary>
        ///     Asserts that an array of <see cref="TimeSpan"/> <see cref="ExpressionOperator.NotEqual"/> expression is generated correctly.
        /// </summary>
        [Fact]
        void Assert_TimeSpan_Array_Inequality_Expression_Is_Generated_Correctly();
        ...
        /// </summary>
        [Fact]
        void Assert_TimeSpan_Array_Contains_Single_Value_Expression_Is_Generated_Correctly();
        ...
        /// </summary>
        [Fact]
        void Assert_TimeSpan_Collection_Equality_Expression_Is_Generated_Correctly();

        /// <summary>
        ///     Asserts that an collection of <see cref="TimeSpan"/> <see cref="ExpressionOperator.NotEqual"/> expression is generated correctly.
        /// </summary>
        [Fact]
        void Assert_TimeSpan_Collection_Inequality_Expression_Is_Generated_Correctly();
        ...
        /// </summary>
        [Fact]
        void Assert_TimeSpan_Collection_Contains_Single_Value_Expression_Is_Generated_Correctly();
    }
}
