namespace Exprelsior.Tests.ExpressionBuilder.SimpleExpressions.Integer.Contracts
{
    ...
    /// </summary>
    public interface IExpressionBuilderIntegerTests
    {
        // DateTime
        ...
        /// </summary>
        [Fact]
        void Assert_Integer_Array_Equality_Expression_Is_Generated_Correctly();

        /// <summary>
        ///     Asserts that an array of <see cref="int"/> <see cref="ExpressionOperator.NotEqual"/> expression is generated correctly.
        /// </summary>
        [Fact]
        void Assert_Integer_Array_Inequality_Expression_Is_Generated_Correctly();
        ...
        /// </summary>
        [Fact]
        void Assert_Integer_Array_Contains_Single_Value_Expression_Is_Generated_Correctly();
        ...
        /// </summary>
        [Fact]
        void Assert_Integer_Collection_Equality_Expression_Is_Generated_Correctly();

        /// <summary>
        ///     Asserts that an collection of <see cref="int"/> <see cref="ExpressionOperator.NotEqual"/> expression is generated correctly.
        /// </summary>
        [Fact]
        void Assert_Integer_Collection_Inequality_Expression_Is_Generated_Correctly();
        ...
        /// </summary>
        [Fact]
        void Assert_Integer_Collection_Contains_Single_Value_Expression_Is_Generated_Correctly();
    }
}
