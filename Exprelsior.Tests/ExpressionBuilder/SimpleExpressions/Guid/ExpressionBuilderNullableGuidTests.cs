namespace Exprelsior.Tests.ExpressionBuilder.SimpleExpressions.Guid
{
    ...
    public class ExpressionBuilderNullableGuidTests : ExpressionBuilderTestBase, IExpressionBuilderNullableGuidTests
    {
        ...
        public void Assert_Nullable_Guid_Equality_Expression_Is_Generated_Correctly()
        {
            ...
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.NullableGuid), randomHydra.NullableGuid, ExpressionOperator.Equal);
        ...
        public void Assert_Nullable_Guid_Inequality_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.NullableGuid), randomHydra.NullableGuid, ExpressionOperator.NotEqual);
        ...
        public void Assert_Nullable_Guid_Contains_On_Value_Expression_Is_Generated_Correctly()
        {
            ...
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.NullableGuid), randomGuids, ExpressionOperator.ContainsOnValue);
            ...
            Assert.DoesNotContain(result, t => !randomGuids.Contains(t.NullableGuid));
        }
        ...
        public void Assert_Nullable_Guid_Array_Equality_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.NullableGuidArray), randomHydra.NullableGuidArray, ExpressionOperator.Equal);
        ...
        public void Assert_Nullable_Guid_Array_Inequality_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.NullableGuidArray), randomHydra.NullableGuidArray, ExpressionOperator.NotEqual);
        ...
        public void Assert_Nullable_Guid_Array_Equality_Expression_With_List_Value_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.NullableGuidArray), randomHydra.NullableGuidArray.ToList(), ExpressionOperator.Equal);
        ...
        public void Assert_Nullable_Guid_Array_Inequality_Expression_With_List_Value_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.NullableGuidArray), randomHydra.NullableGuidArray.ToList(), ExpressionOperator.NotEqual);
        ...
        public void Assert_Nullable_Guid_Array_Contains_Single_Value_Expression_Is_Generated_Correctly()
        {
            ...
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.NullableGuidArray), randomGuid, ExpressionOperator.Contains);
        ...
        public void Assert_Nullable_Guid_Collection_Equality_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.NullableGuidCollection), randomHydra.NullableGuidCollection, ExpressionOperator.Equal);
        ...
        public void Assert_Nullable_Guid_Collection_Inequality_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.NullableGuidCollection), randomHydra.NullableGuidCollection, ExpressionOperator.NotEqual);
        ...
        public void Assert_Nullable_Guid_Collection_Equality_Expression_With_Array_Value_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.NullableGuidCollection), randomHydra.NullableGuidCollection.ToArray(), ExpressionOperator.Equal);
        ...
        public void Assert_Nullable_Guid_Collection_Inequality_Expression_With_Array_Value_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.NullableGuidCollection), randomHydra.NullableGuidCollection.ToArray(), ExpressionOperator.NotEqual);
        ...
        public void Assert_Nullable_Guid_Collection_Contains_Single_Value_Expression_Is_Generated_Correctly()
        {
            ...
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.NullableGuidCollection), randomGuid, ExpressionOperator.Contains);
            ...
            Assert.DoesNotContain(result, t => !t.NullableGuidCollection.Contains(randomGuid));
        }
    }
}
