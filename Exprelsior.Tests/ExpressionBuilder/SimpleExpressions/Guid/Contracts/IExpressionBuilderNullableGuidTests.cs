namespace Exprelsior.Tests.ExpressionBuilder.SimpleExpressions.Guid.Contracts
{
    using System;
    ...
    /// </summary>
    public interface IExpressionBuilderNullableGuidTests
    {
        // Guid
        ...
        /// </summary>
        [Fact]
        void Assert_Nullable_Guid_Equality_Expression_Is_Generated_Correctly();

        /// <summary>
        ///     Asserts that an <see cref="Guid"/>? <see cref="ExpressionOperator.NotEqual"/> expression is generated correctly.
        /// </summary>
        [Fact]
        void Assert_Nullable_Guid_Inequality_Expression_Is_Generated_Correctly();

        /// <summary>
        ///     Asserts that an <see cref="Guid"/>? <see cref="ExpressionOperator.Contains"/> on value expression is generated correctly.
        /// </summary>
        [Fact]
        void Assert_Nullable_Guid_Contains_On_Value_Expression_Is_Generated_Correctly();
        ...
        /// </summary>
        [Fact]
        void Assert_Nullable_Guid_Array_Equality_Expression_Is_Generated_Correctly();

        /// <summary>
        ///     Asserts that an array of <see cref="Guid"/>? <see cref="ExpressionOperator.NotEqual"/> expression is generated correctly.
        /// </summary>
        [Fact]
        void Assert_Nullable_Guid_Array_Inequality_Expression_Is_Generated_Correctly();
        ...
        /// </summary>
        [Fact]
        void Assert_Nullable_Guid_Array_Contains_Single_Value_Expression_Is_Generated_Correctly();
        ...
        /// </summary>
        [Fact]
        void Assert_Nullable_Guid_Collection_Equality_Expression_Is_Generated_Correctly();

        /// <summary>
        ///     Asserts that an collection of <see cref="Guid"/>? <see cref="ExpressionOperator.NotEqual"/> expression is generated correctly.
        /// </summary>
        [Fact]
        void Assert_Nullable_Guid_Collection_Inequality_Expression_Is_Generated_Correctly();
        ...
        /// </summary>
        [Fact]
        void Assert_Nullable_Guid_Collection_Contains_Single_Value_Expression_Is_Generated_Correctly();
    }
}
