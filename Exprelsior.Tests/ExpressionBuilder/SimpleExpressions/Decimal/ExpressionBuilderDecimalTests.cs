namespace Exprelsior.Tests.ExpressionBuilder.SimpleExpressions.Decimal
{
    using System.Linq;
    using Exprelsior.ExpressionBuilder;
    using Exprelsior.ExpressionBuilder.Enums;
    using Exprelsior.Tests.ExpressionBuilder.SimpleExpressions.Decimal.Contracts;
    ...
    public class ExpressionBuilderDecimalTests : ExpressionBuilderTestBase, IExpressionBuilderDecimalTests
    {
        ...
        public void Assert_Decimal_Equality_Expression_Is_Generated_Correctly()
        {
            ...
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.Decimal), randomHydra.Decimal, ExpressionOperator.Equal);
        ...
        public void Assert_Decimal_Inequality_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.Decimal), randomHydra.Decimal, ExpressionOperator.NotEqual);
        ...
        public void Assert_Decimal_Less_Than_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.Decimal), randomHydra.Decimal, ExpressionOperator.LessThan);
        ...
        public void Assert_Decimal_Less_Than_Or_Equal_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.Decimal), randomHydra.Decimal, ExpressionOperator.LessThanOrEqual);
        ...
        public void Assert_Decimal_Greater_Than_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.Decimal), randomHydra.Decimal, ExpressionOperator.GreaterThan);
        ...
        public void Assert_Decimal_Greater_Than_Or_Equal_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.Decimal), randomHydra.Decimal, ExpressionOperator.GreaterThanOrEqual);
        ...
        public void Assert_Decimal_Contains_On_Value_Expression_Is_Generated_Correctly()
        {
            ...
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.Decimal), randomDecimals, ExpressionOperator.ContainsOnValue);
        ...
        public void Assert_Decimal_Array_Equality_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.DecimalArray), randomHydra.DecimalArray, ExpressionOperator.Equal);
        ...
        public void Assert_Decimal_Array_Inequality_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.DecimalArray), randomHydra.DecimalArray, ExpressionOperator.NotEqual);
        ...
        public void Assert_Decimal_Array_Equality_Expression_With_List_Value_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.DecimalArray), randomHydra.DecimalArray.ToList(), ExpressionOperator.Equal);
        ...
        public void Assert_Decimal_Array_Inequality_Expression_With_List_Value_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.DecimalArray), randomHydra.DecimalArray.ToList(), ExpressionOperator.NotEqual);
        ...
        public void Assert_Decimal_Array_Contains_Single_Value_Expression_Is_Generated_Correctly()
        {
            ...
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.DecimalArray), randomDecimal, ExpressionOperator.Contains);
        ...
        public void Assert_Decimal_Collection_Equality_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.DecimalCollection), randomHydra.DecimalCollection, ExpressionOperator.Equal);
        ...
        public void Assert_Decimal_Collection_Inequality_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.DecimalCollection), randomHydra.DecimalCollection, ExpressionOperator.NotEqual);
        ...
        public void Assert_Decimal_Collection_Equality_Expression_With_Array_Value_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.DecimalCollection), randomHydra.DecimalCollection.ToArray(), ExpressionOperator.Equal);
        ...
        public void Assert_Decimal_Collection_Inequality_Expression_With_Array_Value_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.DecimalCollection), randomHydra.DecimalCollection.ToArray(), ExpressionOperator.NotEqual);
        ...
        public void Assert_Decimal_Collection_Contains_Single_Value_Expression_Is_Generated_Correctly()
        {
            ...
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.DecimalCollection), randomDecimal, ExpressionOperator.Contains);
