namespace Exprelsior.Tests.ExpressionBuilder.SimpleExpressions.Decimal.Contracts
{
    ...
    /// </summary>
    public interface IExpressionBuilderNullableDecimalTests
    {
        // Decimal
        ...
        /// </summary>
        [Fact]
        void Assert_Nullable_Decimal_Array_Equality_Expression_Is_Generated_Correctly();

        /// <summary>
        ///     Asserts that an array of <see cref="decimal"/>? <see cref="ExpressionOperator.NotEqual"/> expression is generated correctly.
        /// </summary>
        [Fact]
        void Assert_Nullable_Decimal_Array_Inequality_Expression_Is_Generated_Correctly();
        ...
        /// </summary>
        [Fact]
        void Assert_Nullable_Decimal_Array_Contains_Single_Value_Expression_Is_Generated_Correctly();
        ...
        /// </summary>
        [Fact]
        void Assert_Nullable_Decimal_Collection_Equality_Expression_Is_Generated_Correctly();

        /// <summary>
        ///     Asserts that an collection of <see cref="decimal"/>? <see cref="ExpressionOperator.NotEqual"/> expression is generated correctly.
        /// </summary>
        [Fact]
        void Assert_Nullable_Decimal_Collection_Inequality_Expression_Is_Generated_Correctly();
        ...
        /// </summary>
        [Fact]
        void Assert_Nullable_Decimal_Collection_Contains_Single_Value_Expression_Is_Generated_Correctly();
    }
}
