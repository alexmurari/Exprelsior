namespace Exprelsior.Tests.ExpressionBuilder.SimpleExpressions.Boolean
{
    ...
    /// </summary>
    public class ExpressionBuilderNullableBooleanTests : ExpressionBuilderTestBase, IExpressionBuilderNullableBooleanTests
    {
        /// <summary>
        ///     Initializes a new instance of the <see cref="ExpressionBuilderNullableBooleanTests"/> class.
        /// </summary>
        /// <param name="testOutput">
        ///     The class responsible for providing test output.
        /// </param>
        public ExpressionBuilderNullableBooleanTests(ITestOutputHelper testOutput) : base(testOutput)
        {
        }
        ...
        /// </summary>
        [Fact]
        public void Assert_Nullable_Boolean_Equality_Expression_Is_Generated_Correctly()
        {
            // Arrange
        ...
        /// </summary>
        [Fact]
        public void Assert_Nullable_Boolean_Inequality_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
        ...
        /// </summary>
        [Fact]
        public void Assert_Nullable_Boolean_Array_Equality_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
        ...
        /// </summary>
        [Fact]
        public void Assert_Nullable_Boolean_Array_Inequality_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
        ...
        /// </summary>
        [Fact]
        public void Assert_Nullable_Boolean_Collection_Equality_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
        ...
        /// </summary>
        [Fact]
        public void Assert_Nullable_Boolean_Collection_Contains_Single_Value_Expression_Is_Generated_Correctly()
        {
            // Arrange
