namespace Exprelsior.Tests.ExpressionBuilder.SimpleExpressions.Boolean.Contracts
{
    ...
    /// </summary>
    public interface IExpressionBuilderBooleanTests
    {
        // Boolean
        ...
        /// </summary>
        [Fact]
        void Assert_Boolean_Array_Equality_Expression_Is_Generated_Correctly();

        /// <summary>
        ///     Asserts that an array of <see cref="bool"/> <see cref="ExpressionOperator.NotEqual"/> expression is generated correctly.
        /// </summary>
        [Fact]
        void Assert_Boolean_Array_Inequality_Expression_Is_Generated_Correctly();
        ...
        /// </summary>
        [Fact]
        void Assert_Boolean_Array_Contains_Single_Value_Expression_Is_Generated_Correctly();
        ...
        /// </summary>
        [Fact]
        void Assert_Boolean_Collection_Equality_Expression_Is_Generated_Correctly();

        /// <summary>
        ///     Asserts that an collection of <see cref="bool"/> <see cref="ExpressionOperator.NotEqual"/> expression is generated correctly.
        /// </summary>
        [Fact]
        void Assert_Boolean_Collection_Inequality_Expression_Is_Generated_Correctly();
        ...
        /// </summary>
        [Fact]
        void Assert_Boolean_Collection_Contains_Single_Value_Expression_Is_Generated_Correctly();
    }
}
