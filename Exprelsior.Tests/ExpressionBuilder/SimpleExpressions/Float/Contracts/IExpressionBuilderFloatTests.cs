namespace Exprelsior.Tests.ExpressionBuilder.SimpleExpressions.Float.Contracts
{
    ...
    /// </summary>
    public interface IExpressionBuilderFloatTests
    {
        // DateTime
        ...
        /// </summary>
        [Fact]
        void Assert_Float_Array_Equality_Expression_Is_Generated_Correctly();

        /// <summary>
        ///     Asserts that an array of <see cref="float"/> <see cref="ExpressionOperator.NotEqual"/> expression is generated correctly.
        /// </summary>
        [Fact]
        void Assert_Float_Array_Inequality_Expression_Is_Generated_Correctly();
        ...
        /// </summary>
        [Fact]
        void Assert_Float_Array_Contains_Single_Value_Expression_Is_Generated_Correctly();
        ...
        /// </summary>
        [Fact]
        void Assert_Float_Collection_Equality_Expression_Is_Generated_Correctly();

        /// <summary>
        ///     Asserts that an collection of <see cref="float"/> <see cref="ExpressionOperator.NotEqual"/> expression is generated correctly.
        /// </summary>
        [Fact]
        void Assert_Float_Collection_Inequality_Expression_Is_Generated_Correctly();
        ...
        /// </summary>
        [Fact]
        void Assert_Float_Collection_Contains_Single_Value_Expression_Is_Generated_Correctly();
    }
}
