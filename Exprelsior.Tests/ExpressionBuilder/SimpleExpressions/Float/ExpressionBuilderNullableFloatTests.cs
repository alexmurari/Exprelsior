namespace Exprelsior.Tests.ExpressionBuilder.SimpleExpressions.Float
{
    ...
    public class ExpressionBuilderNullableFloatTests : ExpressionBuilderTestBase, IExpressionBuilderNullableFloatTests
    {
        ...
        public void Assert_Nullable_Float_Equality_Expression_Is_Generated_Correctly()
        {
            ...
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.NullableFloat), randomHydra.NullableFloat, ExpressionOperator.Equal);
        ...
        public void Assert_Nullable_Float_Inequality_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.NullableFloat), randomHydra.NullableFloat, ExpressionOperator.NotEqual);
        ...
        public void Assert_Nullable_Float_Less_Than_Expression_Is_Generated_Correctly()
        {
            ...
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.NullableFloat), randomHydra.NullableFloat, ExpressionOperator.LessThan);
        ...
        public void Assert_Nullable_Float_Less_Than_Or_Equal_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy.Where(t => t.NullableFloat.HasValue));
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.NullableFloat), randomHydra.NullableFloat, ExpressionOperator.LessThanOrEqual);
        ...
        public void Assert_Nullable_Float_Greater_Than_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy.Where(t => t.NullableFloat.HasValue));
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.NullableFloat), randomHydra.NullableFloat, ExpressionOperator.GreaterThan);
        ...
        public void Assert_Nullable_Float_Greater_Than_Or_Equal_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy.Where(t => t.NullableFloat.HasValue));
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.NullableFloat), randomHydra.NullableFloat, ExpressionOperator.GreaterThanOrEqual);
        ...
        public void Assert_Nullable_Float_Contains_On_Value_Expression_Is_Generated_Correctly()
        {
            ...
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.NullableFloat), randomFloats, ExpressionOperator.ContainsOnValue);
        ...
        public void Assert_Nullable_Float_Array_Equality_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.NullableFloatArray), randomHydra.NullableFloatArray, ExpressionOperator.Equal);
        ...
        public void Assert_Nullable_Float_Array_Inequality_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.NullableFloatArray), randomHydra.NullableFloatArray, ExpressionOperator.NotEqual);
        ...
        public void Assert_Nullable_Float_Array_Equality_Expression_With_List_Value_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.NullableFloatArray), randomHydra.NullableFloatArray.ToList(), ExpressionOperator.Equal);
        ...
        public void Assert_Nullable_Float_Array_Inequality_Expression_With_List_Value_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.NullableFloatArray), randomHydra.NullableFloatArray.ToList(), ExpressionOperator.NotEqual);
        ...
        public void Assert_Nullable_Float_Array_Contains_Single_Value_Expression_Is_Generated_Correctly()
        {
            ...
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.NullableFloatArray), randomFloat, ExpressionOperator.Contains);
        ...
        public void Assert_Nullable_Float_Collection_Equality_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.NullableFloatCollection), randomHydra.NullableFloatCollection, ExpressionOperator.Equal);
        ...
        public void Assert_Nullable_Float_Collection_Inequality_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.NullableFloatCollection), randomHydra.NullableFloatCollection, ExpressionOperator.NotEqual);
        ...
        public void Assert_Nullable_Float_Collection_Equality_Expression_With_Array_Value_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.NullableFloatCollection), randomHydra.NullableFloatCollection.ToArray(), ExpressionOperator.Equal);
        ...
        public void Assert_Nullable_Float_Collection_Inequality_Expression_With_Array_Value_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.NullableFloatCollection), randomHydra.NullableFloatCollection.ToArray(), ExpressionOperator.NotEqual);
        ...
        public void Assert_Nullable_Float_Collection_Contains_Single_Value_Expression_Is_Generated_Correctly()
        {
            ...
            var expression = ExpressionBuilder.CreateBinary<Hydra>(nameof(Hydra.NullableFloatCollection), randomFloat, ExpressionOperator.Contains);
