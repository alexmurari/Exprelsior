namespace Exprelsior.Tests.ExpressionBuilder.Integer
{
    ...
    public class ExpressionBuilderNullableIntegerTests : ExpressionBuilderTestBase, IExpressionBuilderNullableIntegerTests
    {
        ...
        public void Assert_Nullable_Integer_Equality_Expression_Is_Generated_Correctly()
        {
            ...
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.NullableInteger), randomHydra.NullableInteger, ExpressionOperator.Equal);
        ...
        public void Assert_Nullable_Integer_Inequality_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.NullableInteger), randomHydra.NullableInteger, ExpressionOperator.NotEqual);
        ...
        public void Assert_Nullable_Integer_Less_Than_Expression_Is_Generated_Correctly()
        {
            ...
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.NullableInteger), randomHydra.NullableInteger, ExpressionOperator.LessThan);
        ...
        public void Assert_Nullable_Integer_Less_Than_Or_Equal_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy.Where(t => t.NullableInteger.HasValue));
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.NullableInteger), randomHydra.NullableInteger, ExpressionOperator.LessThanOrEqual);
        ...
        public void Assert_Nullable_Integer_Greater_Than_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy.Where(t => t.NullableInteger.HasValue));
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.NullableInteger), randomHydra.NullableInteger, ExpressionOperator.GreaterThan);
        ...
        public void Assert_Nullable_Integer_Greater_Than_Or_Equal_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy.Where(t => t.NullableInteger.HasValue));
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.NullableInteger), randomHydra.NullableInteger, ExpressionOperator.GreaterThanOrEqual);
        ...
        public void Assert_Nullable_Integer_Contains_On_Value_Expression_Is_Generated_Correctly()
        {
            ...
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.NullableInteger), randomIntegers, ExpressionOperator.ContainsOnValue);
        ...
        public void Assert_Nullable_Integer_Array_Equality_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.NullableIntegerArray), randomHydra.NullableIntegerArray, ExpressionOperator.Equal);
        ...
        public void Assert_Nullable_Integer_Array_Inequality_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.NullableIntegerArray), randomHydra.NullableIntegerArray, ExpressionOperator.NotEqual);
        ...
        public void Assert_Nullable_Integer_Array_Equality_Expression_With_List_Value_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.NullableIntegerArray), randomHydra.NullableIntegerArray.ToList(), ExpressionOperator.Equal);
        ...
        public void Assert_Nullable_Integer_Array_Inequality_Expression_With_List_Value_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.NullableIntegerArray), randomHydra.NullableIntegerArray.ToList(), ExpressionOperator.NotEqual);
        ...
        public void Assert_Nullable_Integer_Array_Contains_Single_Value_Expression_Is_Generated_Correctly()
        {
            ...
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.NullableIntegerArray), randomInteger, ExpressionOperator.Contains);
        ...
        public void Assert_Nullable_Integer_Collection_Equality_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.NullableIntegerCollection), randomHydra.NullableIntegerCollection, ExpressionOperator.Equal);
        ...
        public void Assert_Nullable_Integer_Collection_Inequality_Expression_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.NullableIntegerCollection), randomHydra.NullableIntegerCollection, ExpressionOperator.NotEqual);
        ...
        public void Assert_Nullable_Integer_Collection_Equality_Expression_With_Array_Value_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.NullableIntegerCollection), randomHydra.NullableIntegerCollection.ToArray(), ExpressionOperator.Equal);
        ...
        public void Assert_Nullable_Integer_Collection_Inequality_Expression_With_Array_Value_Is_Generated_Correctly()
        {
            // Arrange
            var randomHydra = Utilities.GetRandomItem(HydraArmy);
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.NullableIntegerCollection), randomHydra.NullableIntegerCollection.ToArray(), ExpressionOperator.NotEqual);
        ...
        public void Assert_Nullable_Integer_Collection_Contains_Single_Value_Expression_Is_Generated_Correctly()
        {
            ...
            var expression = ExpressionBuilder.CreateBinaryExpression<Hydra>(nameof(Hydra.NullableIntegerCollection), randomInteger, ExpressionOperator.Contains);
