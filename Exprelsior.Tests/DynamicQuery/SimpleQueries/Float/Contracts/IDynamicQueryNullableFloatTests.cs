namespace Exprelsior.Tests.DynamicQuery.SimpleQueries.Float.Contracts
{
    ...
    /// </summary>
    public interface IDynamicQueryNullableFloatTests
    {
        // Float
        ...
        /// </summary>
        [Fact]
        void Assert_Nullable_Float_Array_Equality_Dynamic_Query_Expression_Is_Generated_Correctly();

        /// <summary>
        ///     Asserts that an array of <see cref="float"/>? <see cref="ExpressionOperator.NotEqual"/> expression is generated correctly.
        /// </summary>
        [Fact]
        void Assert_Nullable_Float_Array_Inequality_Dynamic_Query_Expression_Is_Generated_Correctly();
        ...
        /// </summary>
        [Fact]
        void Assert_Nullable_Float_Array_Contains_Single_Value_Dynamic_Query_Expression_Is_Generated_Correctly();
        ...
        /// </summary>
        [Fact]
        void Assert_Nullable_Float_Collection_Equality_Dynamic_Query_Expression_Is_Generated_Correctly();

        /// <summary>
        ///     Asserts that an collection of <see cref="float"/>? <see cref="ExpressionOperator.NotEqual"/> expression is generated correctly.
        /// </summary>
        [Fact]
        void Assert_Nullable_Float_Collection_Inequality_Dynamic_Query_Expression_Is_Generated_Correctly();
        ...
        /// </summary>
        [Fact]
        void Assert_Nullable_Float_Collection_Contains_Single_Value_Dynamic_Query_Expression_Is_Generated_Correctly();
    }
}
