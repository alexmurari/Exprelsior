namespace Exprelsior.Tests.DynamicQuery.SimpleQueries.Boolean.Contracts
{
    ...
    /// </summary>
    public interface IDynamicQueryNullableBooleanTests
    {
        // Boolean
        ...
        /// </summary>
        [Fact]
        void Assert_Nullable_Boolean_Equality_Dynamic_Query_Expression_Is_Generated_Correctly();

        /// <summary>
        ///     Asserts that an <see cref="bool"/>? <see cref="ExpressionOperator.NotEqual"/> expression is generated correctly.
        /// </summary>
        [Fact]
        void Assert_Nullable_Boolean_Inequality_Dynamic_Query_Expression_Is_Generated_Correctly();

        /// <summary>
        ///     Asserts that an <see cref="bool"/>? <see cref="ExpressionOperator.Contains"/> on value expression is generated correctly.
        /// </summary>
        [Fact]
        void Assert_Nullable_Boolean_Contains_On_Value_Dynamic_Query_Expression_Is_Generated_Correctly();
        ...
        /// </summary>
        [Fact]
        void Assert_Nullable_Boolean_Array_Equality_Dynamic_Query_Expression_Is_Generated_Correctly();

        /// <summary>
        ///     Asserts that an array of <see cref="bool"/>? <see cref="ExpressionOperator.NotEqual"/> expression is generated correctly.
        /// </summary>
        [Fact]
        void Assert_Nullable_Boolean_Array_Inequality_Dynamic_Query_Expression_Is_Generated_Correctly();
        ...
        /// </summary>
        [Fact]
        void Assert_Nullable_Boolean_Array_Contains_Single_Value_Dynamic_Query_Expression_Is_Generated_Correctly();
        ...
        /// </summary>
        [Fact]
        void Assert_Nullable_Boolean_Collection_Equality_Dynamic_Query_Expression_Is_Generated_Correctly();

        /// <summary>
        ///     Asserts that an collection of <see cref="bool"/>? <see cref="ExpressionOperator.NotEqual"/> expression is generated correctly.
        /// </summary>
        [Fact]
        void Assert_Nullable_Boolean_Collection_Inequality_Dynamic_Query_Expression_Is_Generated_Correctly();
        ...
        /// </summary>
        [Fact]
        void Assert_Nullable_Boolean_Collection_Contains_Single_Value_Dynamic_Query_Expression_Is_Generated_Correctly();
    }
}
