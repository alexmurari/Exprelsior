namespace Exprelsior.Tests.DynamicQuery.SimpleQueries.Char.Contracts
{
    ...
    /// </summary>
    public interface IDynamicQueryCharTests
    {
        // Char
        ...
        /// </summary>
        [Fact]
        void Assert_Char_Equality_Dynamic_Query_Expression_Is_Generated_Correctly();

        /// <summary>
        ///     Asserts that an <see cref="char"/> <see cref="ExpressionOperator.NotEqual"/> expression is generated correctly.
        /// </summary>
        [Fact]
        void Assert_Char_Inequality_Dynamic_Query_Expression_Is_Generated_Correctly();

        /// <summary>
        ///     Asserts that an <see cref="char"/> <see cref="ExpressionOperator.Contains"/> on value expression is generated correctly.
        /// </summary>
        [Fact]
        void Assert_Char_Contains_On_Value_Dynamic_Query_Expression_Is_Generated_Correctly();
        ...
        /// </summary>
        [Fact]
        void Assert_Char_Array_Equality_Dynamic_Query_Expression_Is_Generated_Correctly();

        /// <summary>
        ///     Asserts that an array of <see cref="char"/> <see cref="ExpressionOperator.NotEqual"/> expression is generated correctly.
        /// </summary>
        [Fact]
        void Assert_Char_Array_Inequality_Dynamic_Query_Expression_Is_Generated_Correctly();
        ...
        /// </summary>
        [Fact]
        void Assert_Char_Array_Equality_Expression_With_List_Value_Is_Generated_Correctly();
        ...
        /// </summary>
        [Fact]
        void Assert_Char_Array_Inequality_Expression_With_List_Value_Is_Generated_Correctly();
        ...
        /// </summary>
        [Fact]
        void Assert_Char_Array_Contains_Single_Value_Dynamic_Query_Expression_Is_Generated_Correctly();
        ...
        /// </summary>
        [Fact]
        void Assert_Char_Collection_Equality_Dynamic_Query_Expression_Is_Generated_Correctly();

        /// <summary>
        ///     Asserts that an collection of <see cref="char"/> <see cref="ExpressionOperator.NotEqual"/> expression is generated correctly.
        /// </summary>
        [Fact]
        void Assert_Char_Collection_Inequality_Dynamic_Query_Expression_Is_Generated_Correctly();
        ...
        /// </summary>
        [Fact]
        void Assert_Char_Collection_Equality_Expression_With_Array_Value_Is_Generated_Correctly();
        ...
        /// </summary>
        [Fact]
        void Assert_Char_Collection_Inequality_Expression_With_Array_Value_Is_Generated_Correctly();
        ...
        /// </summary>
        [Fact]
        void Assert_Char_Collection_Contains_Single_Value_Dynamic_Query_Expression_Is_Generated_Correctly();
    }
}
