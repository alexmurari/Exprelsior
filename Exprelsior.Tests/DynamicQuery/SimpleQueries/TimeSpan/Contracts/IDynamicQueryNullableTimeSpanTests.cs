namespace Exprelsior.Tests.DynamicQuery.SimpleQueries.TimeSpan.Contracts
{
    using System;
    ...
    /// </summary>
    public interface IDynamicQueryNullableTimeSpanTests
    {
        // TimeSpan
        ...
        /// </summary>
        [Fact]
        void Assert_Nullable_TimeSpan_Array_Equality_Dynamic_Query_Expression_Is_Generated_Correctly();

        /// <summary>
        ///     Asserts that an array of <see cref="TimeSpan"/>? <see cref="ExpressionOperator.NotEqual"/> expression is generated correctly.
        /// </summary>
        [Fact]
        void Assert_Nullable_TimeSpan_Array_Inequality_Dynamic_Query_Expression_Is_Generated_Correctly();
        ...
        /// </summary>
        [Fact]
        void Assert_Nullable_TimeSpan_Array_Contains_Single_Value_Dynamic_Query_Expression_Is_Generated_Correctly();
        ...
        /// </summary>
        [Fact]
        void Assert_Nullable_TimeSpan_Collection_Equality_Dynamic_Query_Expression_Is_Generated_Correctly();

        /// <summary>
        ///     Asserts that an collection of <see cref="TimeSpan"/>? <see cref="ExpressionOperator.NotEqual"/> expression is generated correctly.
        /// </summary>
        [Fact]
        void Assert_Nullable_TimeSpan_Collection_Inequality_Dynamic_Query_Expression_Is_Generated_Correctly();
        ...
        /// </summary>
        [Fact]
        void Assert_Nullable_TimeSpan_Collection_Contains_Single_Value_Dynamic_Query_Expression_Is_Generated_Correctly();
    }
}
