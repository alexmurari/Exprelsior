namespace Exprelsior.Tests.DynamicQuery.DateTime.Contracts
{
    using System;
    using Xunit;
    ...
    /// </summary>
    public interface IDynamicQueryDateTimeTests
    {
        // DateTime
        ...
        /// </summary>
        [Fact]
        void Assert_DateTime_Array_Equality_Dynamic_Query_Expression_Is_Generated_Correctly();

        /// <summary>
        ///     Asserts that an array of <see cref="DateTime"/> <see cref="ExpressionOperator.NotEqual"/> expression is generated correctly.
        /// </summary>
        [Fact]
        void Assert_DateTime_Array_Inequality_Dynamic_Query_Expression_Is_Generated_Correctly();
        ...
        /// </summary>
        [Fact]
        void Assert_DateTime_Array_Contains_Single_Value_Dynamic_Query_Expression_Is_Generated_Correctly();
        ...
        /// </summary>
        [Fact]
        void Assert_DateTime_Collection_Equality_Dynamic_Query_Expression_Is_Generated_Correctly();

        /// <summary>
        ///     Asserts that an collection of <see cref="DateTime"/> <see cref="ExpressionOperator.NotEqual"/> expression is generated correctly.
        /// </summary>
        [Fact]
        void Assert_DateTime_Collection_Inequality_Dynamic_Query_Expression_Is_Generated_Correctly();
        ...
        /// </summary>
        [Fact]
        void Assert_DateTime_Collection_Contains_Single_Value_Dynamic_Query_Expression_Is_Generated_Correctly();
    }
}
